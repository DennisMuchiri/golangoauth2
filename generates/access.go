...
func (ag *AccessGenerate) Token(ctx context.Context, data *oauth2.GenerateBasic, isGenRefresh bool, gt *oauth2.GrantType) (string, string, error, string, string) {
	...
	return access, refresh, nil, "", data.AuthType
}
